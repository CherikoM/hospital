<template>
  <svg t="1696431132935" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2795"
    ...
    <path
      ...
      :fill="props.fill" p-id="2796"></path>
    <path d="M512 304c9.6 0 16 6.4 16 16v256c0 9.6-6.4 16-16 16s-16-6.4-16-16v-256c0-9.6 6.4-16 16-16z" fill="#D8D8D8"
      p-id="2797"></path>
    <path
      d="M512 608c-19.2 0-32-12.8-32-32v-256c0-19.2 12.8-32 32-32s32 12.8 32 32v256c0 19.2-12.8 32-32 32z m0-304v16-16z"
      :fill="props.fill" p-id="2798"></path>
    <path
      ...
      :fill="props.fill" p-id="2799"></path>
    <path
      ...
      :fill="props.fill" p-id="2800"></path>
  </svg>
</template>
